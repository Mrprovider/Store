...
│
├🔸👨‍💻 **Developer:** [@KUSHALHK](https://t.me/KUSHALHK) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/TG_LINKS_CHANNEL)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/TG_UPDATES1)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@KUSHALHK](https://t.me/KUSHALHK) 
...
[**Donate Me**](harikushal234@okicici) (𝐔𝐏𝐈 𝐈𝐃)
"""
	HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
